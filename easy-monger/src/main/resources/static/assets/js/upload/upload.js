(function ($) {
    ...
    $(function () {
        ...
        function setState(val) {
            ...
            switch (state) {
                ...
                case 'finish':
                    stats = uploader.getStats();
                    if (stats.successNum) {
                        // comment by tony --> document.getElementById("shareUrl").style.visibility = 'visible';
                        // comment by tony --> createQrcode();
                    } else {
                        // 没有成功的图片，重设
                        state = 'done';
                        location.reload();
        ...
        $upload.on('click', function () {
            ...
            debugger;
            //var selectedAccount = $("#accounts option:selected").text();
            //var account = selectedAccount.slice(0, selectedAccount.indexOf("("));
            uploader.options.formData.accountId = $("#accounts option:selected").val();
