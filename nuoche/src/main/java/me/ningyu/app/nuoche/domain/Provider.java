...
{
    @Column(name = "vendor", columnDefinition = "VARCHAR(50) DEFAULT 0 COMMENT '推送服务的服务商'")
    ...
    @Column(name = "push_key", columnDefinition = "VARCHAR(50) DEFAULT 0 COMMENT '推送网站提供的认证Key'")
    private String pushKey;

    @Column(name = "description", columnDefinition = "TEXT DEFAULT '' COMMENT '描述'")
    private String description;

    @Column(name = "weight", columnDefinition = "TINYINT(1) DEFAULT 0 COMMENT '权重'")
